		...
		excel.SetData(
			props.filteredDelayCauses.map((delay) => {
				return {
					...
					causes0: props.all_delays && props.all_delays[delay.causes[0]?.id]?.name,
					causes1: props.all_delays && props.all_delays[delay.causes[1]?.id]?.name,
					causes2: props.all_delays && props.all_delays[delay.causes[2]?.id]?.name,
