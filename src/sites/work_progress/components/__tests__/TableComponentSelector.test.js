...
describe('spliting objects by key ', () => {
	test('should generate same objects', () => {
		expect(splitJobsByKey(objects.jobs, objects.upgrading, 2)).toStrictEqual(expected);
	});
	test('should generate expected with more than save jobs', () => {
		expect(splitJobsByKey(objects.jobs, objects.upgrading, 3)).toStrictEqual(expected2);
	});
});
