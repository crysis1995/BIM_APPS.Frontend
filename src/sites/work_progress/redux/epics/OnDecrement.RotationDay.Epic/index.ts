...
export const OnDecrementRotationDayEpic: Epic<RootActions, RootActions, RootState> = (
	action$,
	state$,
) =>
	action$.pipe(
		filter(
			(
				data,
			): data is ReturnType<WorkProgress.Monolithic.General.Redux.IActions['DecrementDay']> =>
