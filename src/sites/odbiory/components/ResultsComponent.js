              ...
              >
                ...
                >
                  <div className="d-flex justify-content-between">
                    ...
                    <span>
                      {Jobs.jobs[job_key].results.summary_current_value || 0} m
                      <sup>2</sup> /{" "}
                      {Jobs.jobs[job_key].results.summary_all_value || 0} m
                      <sup>2</sup>
                    </span>
                  </div>
                  <ProgressBar
                    results_percentage_area={
                      Jobs.jobs[job_key].results.percentage_value
                    }
                  />
                </ListGroup.Item>
              </OverlayTrigger>
