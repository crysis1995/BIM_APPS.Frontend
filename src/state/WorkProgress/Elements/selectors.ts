...
function GetAllElementsByIdAsDict(state: RootState) {
	return state.WorkProgress.Elements.ElementsByID ?? {};
}
function GetAllElementsByIdAsList(state: RootState) {
	return Object.values(GetAllElementsByIdAsDict(state));
}

function GetAllElementsByRevitIdAsDict(state: RootState) {
	return state.WorkProgress.Elements.ElementsByRevitId ?? {};
}
function GetAllElementsByRevitIdAsList(state: RootState) {
	return Object.values(GetAllElementsByRevitIdAsDict(state));
}
function GetElementByRevitId(state: RootState, revitId: Element['revitId']) {
	return GetAllElementsByRevitIdAsDict(state)?.[revitId] ?? null;
}
function IsElementsLoading(state: RootState) {
	return state.WorkProgress.Elements.ElementsLoading;
}
function GetSelectionByRevitId(state: RootState) {
	return state.WorkProgress.Elements.SelectionByRevitId;
}
function GetSelectedElements(state: RootState) {
	return GetSelectionByRevitId(state).map((revitID) => GetElementByRevitId(state, revitID));
}



export default {
	GetAllElementsByIdAsDict,
	GetAllElementsByIdAsList,
	GetAllElementsByRevitIdAsDict,
	GetAllElementsByRevitIdAsList,
	GetElementByRevitId,
	GetSelectionByRevitId,
	GetSelectedElements,
	IsElementsLoading,
};
