	...
	units: {
		area: {
			color_map: {
				...
				2: { color: "#FF0000", option: "0-25 ", condition: (x) => x > 0 && x < 25 },
				3: { color: "#FFFF00", option: "25-50", condition: (x) => x >= 25 && x < 50 },
				4: { color: "#00B050", option: "50-75", condition: (x) => x >= 50 && x < 75 },
				5: { color: "#00B050", option: "75-100", condition: (x) => x >= 75 && x < 100 },
